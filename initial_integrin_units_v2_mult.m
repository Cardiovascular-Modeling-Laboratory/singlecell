function [integrin_free, integrin_bound, rho_bar, initial_name,percent_err]=initial_integrin_units_v2_mult(Npts_t,Tot_Integrin_Val,dA,Concave_ind,outline,mat_r,rho_bar,initial_choice)

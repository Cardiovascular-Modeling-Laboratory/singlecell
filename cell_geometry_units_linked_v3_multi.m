...
function [mat_r,Npts_t,drx,dry,dA,dr_dist_squared, dist_to_line_sq, shape_name,dist_pair,drx_norm,dry_norm,Concave_ind,outline,nuc_x,nuc_y,nuc_cx,nuc_cy,choice, outside_segs, inside_segs,bdry_mat,bdry_pts,out_ind,Num_points,A,nuc_radius]=cell_geometry_units_linked_v3_multi(Num_points,A,nuc_radius,choice,nuc_decide,nuc_cx_temp,nuc_cy_temp,ARtemp)
...
if choice == 2
    ...
    aspect_ratio = ARtemp; % input('Please specify the aspect ratio, i.e. x/y: ');

...
nuc_rel_vec=[0 1 1 1]; % vector indicating if nucleus is treated as an obstruction (1) or not (0)
...
filename_save = ['paramTEST5_72hr_NucPlacement_fsatlim=18_net2_results_store.mat'];
save(filename_save,'net_res','combo_res','F_res','fiber_id_res','mat_r','nuc_cx_store','nuc_cy_store','dA','outline','nuc_radius','nsim');
